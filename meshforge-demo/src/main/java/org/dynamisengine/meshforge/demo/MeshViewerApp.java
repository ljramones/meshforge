...
public final class MeshViewerApp extends Application {
    ...
    private org.dynamisengine.meshforge.core.mesh.MeshData currentMesh;
    ...
    private void applyFraming(org.dynamisengine.meshforge.core.mesh.MeshData mesh, Group meshNode) {
    ...
    private static float estimateViewRadius(org.dynamisengine.meshforge.core.mesh.MeshData mesh) {
        return estimateViewFrame(mesh).radius;
    }

    private static float[] estimateViewCenter(org.dynamisengine.meshforge.core.mesh.MeshData mesh) {
        ViewFrame f = estimateViewFrame(mesh);
        return new float[] {f.centerX, f.centerY, f.centerZ};
    }

    private static ViewFrame estimateViewFrame(org.dynamisengine.meshforge.core.mesh.MeshData mesh) {
        var bounds = mesh.boundsOrNull();
    ...
    private static org.dynamisengine.meshforge.core.mesh.MeshData ensureConsistentWinding(org.dynamisengine.meshforge.core.mesh.MeshData mesh) {
        int[] indices = mesh.indicesOrNull();
