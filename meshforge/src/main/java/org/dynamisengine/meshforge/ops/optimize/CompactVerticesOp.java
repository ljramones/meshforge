...
public final class CompactVerticesOp implements MeshOp {
    /**
     * Creates a compact-vertices operation.
     */
    public CompactVerticesOp() {
    }
     ...
     * Executes remap.
     * @param mesh parameter value
     * @param remappedIndices parameter value
     * @return resulting value
     */
    ...
    /**
     * Reorders and compacts vertices using an explicit old-to-new map.
     *
     * @param mesh source mesh
     * @param remappedIndices remapped index buffer
     * @param oldToNew mapping from source vertex index to compacted vertex index
     * @param newVertexCount compacted vertex count
     * @return compacted mesh
     */
    ...
    /**
     * Reorders and compacts vertices using an explicit old-to-new map and explicit submesh ranges.
     *
     * @param mesh source mesh
     * @param remappedIndices remapped index buffer
     * @param oldToNew mapping from source vertex index to compacted vertex index
     * @param newVertexCount compacted vertex count
     * @param submeshes target submesh ranges to apply to the compacted mesh
     * @return compacted mesh
     */
    public static MeshData reorderAndCompact(
        MeshData mesh,
